...
> **[📋 API仕様書を見る](/api/StablecoinView)**

## 概要

読み取り専用の関数を集約したビューコントラクトです。ガス消費なしで状態を照会できます。
...
balanceOf、totalSupply等のERC20標準ビュー関数を提供。

### ロール・権限の確認

hasRole、getRoleAdmin等でアカウントの権限状態を確認可能。

### Bank情報の取得

Bank単位の発行上限、発行残高、一時停止状態などを照会可能。
...
<details>
<summary><strong>読み取り関数 (28)</strong></summary>

| 関数名 | 説明 |
|--------|------|
| [`accountLots`](#accountlots) | accountLots |
| [`allowed`](#allowed) | allowed |
| [`bankBalanceOf`](#bankbalanceof) | bankBalanceOf |
| [`bucketBank`](#bucketbank) | bucketBank |
| [`canGrantRole`](#cangrantrole) | grant role が可能かどうかを確認します。 |
| [`canPauseBank`](#canpausebank) | pause bank が可能かどうかを確認します。 |
| [`getAccountBankCursor`](#getaccountbankcursor) | account bank cursor を取得します。 |
| [`getAccountBucketBalance`](#getaccountbucketbalance) | account bucket balance を取得します。 |
| [`getAccountBucketIds`](#getaccountbucketids) | account bucket ids を取得します。 |
| [`getAccountFifoHead`](#getaccountfifohead) | account fifo head を取得します。 |
| [`getAccountGlobalLots`](#getaccountgloballots) | account global lots を取得します。 |
...
| [`getBucketTotal`](#getbuckettotal) | bucket total を取得します。 |
...
| [`isAccountAllowed`](#isaccountallowed) | account allowed かどうかを確認します。 |
| [`isAllowListed`](#isallowlisted) | allow listed かどうかを確認します。 |
...
| [`userBankBalance`](#userbankbalance) | userBankBalance |
...
| 名前 | 型 | 説明 |
|------|-----|------|
| `lots` | `string` | lotsを返します。 |
| `headIndex` | `string` | headIndexを返します。 |
...
| 名前 | 型 | 説明 |
|------|-----|------|
| `result0` | `string` | allowedの結果を返します。 |
...
| 名前 | 型 | 説明 |
|------|-----|------|
| `result0` | `string` | bankBalanceOfの結果を返します。 |
...
### getAccountBankCursor

account bank cursor を取得します。
...
| 名前 | 型 | 説明 |
|------|-----|------|
| `result0` | `string` | AccountBankCursorを返します。 |

---

### getAccountBucketBalance

account bucket balance を取得します。
...
| 名前 | 型 | 説明 |
|------|-----|------|
| `result0` | `string` | AccountBucketBalanceを返します。 |

---

### getAccountBucketIds

account bucket ids を取得します。
...
| 名前 | 型 | 説明 |
|------|-----|------|
| `result0` | `string` | AccountBucketIdsを返します。 |

---

### getAccountFifoHead

account fifo head を取得します。
...
| 名前 | 型 | 説明 |
|------|-----|------|
| `result0` | `string` | AccountFifoHeadを返します。 |

---

### getAccountGlobalLots

account global lots を取得します。
...
| 名前 | 型 | 説明 |
|------|-----|------|
| `result0` | `string` | AccountGlobalLotsを返します。 |
...
| 名前 | 型 | 説明 |
|------|-----|------|
| `result0` | `string` | BucketTotalを返します。 |
...
| 名前 | 型 | 説明 |
|------|-----|------|
| `isAllowed` | `string` | isAllowedを返します。 |

---

### isAllowListed

allow listed かどうかを確認します。
...
| 名前 | 型 | 説明 |
|------|-----|------|
| `result0` | `string` | AllowListedの場合trueを返します。 |
...
| 名前 | 型 | 説明 |
|------|-----|------|
| `result0` | `string` | totalAmountの結果を返します。 |
...
<details>
<summary><strong>書き込み関数 (20)</strong></summary>
...
<details>
<summary><strong>エラー (50)</strong></summary>
